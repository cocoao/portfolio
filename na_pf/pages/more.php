...
<body>
  ...
  <div class="wrap">
    <div class="contents-wrap clear more">
      <section class="mo_imgView clear">
        <div class="title">
          <hr>
        ...
        <div class="moBtns filter-button-group">
          ...
          <button data-filter=".edit" class="edit">Editorial</button>
          <button data-filter=".webedit" class="webedit">Web edit</button>
